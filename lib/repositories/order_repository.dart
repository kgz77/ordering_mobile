...
import 'package:foda/models/order.dart' as Orders;
import 'package:foda/models/result.dart';

class OrderRepository {
  final ordersCollection = FirebaseFirestore.instance.collection("orders");
  ValueNotifier<List<Orders.Order>> ordersNotifier =
      ValueNotifier<List<Orders.Order>>([]);

  Future<Either<ErrorHandler, bool>> createOrder(
      String uid, Orders.Order order) async {
    try {
